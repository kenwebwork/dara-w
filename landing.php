    ...
    <section class="daradara">
      <div class="daradara-inner">
        <div class="dara-left">
          ...
          <div>
            <p>英語学習 = 高いモチベで頑張る！</p>
            <p>この意識は素晴らしいですが、必須要素ではありません。</p>
            <p>高いモチベを維持するのはカロリーが高いです。継続することが一番の習得の近道なので、英語学習の勉強はだらだらでもOKです。</p>
            <p>練習を繰り返していくうちに自然と英語が出せるようになります。「気づいたら練習したことあるフレーズが口から出てた」、このような体験はだらだら勉強でも実現可能です。</p>
